...
class Library extends PureComponent {
  ...
  searchBook = (input) => {
    const searchRes = this.props.books.filter((elemt) =>
      toLower(elemt.title).includes(toLower(input))
    );
  ...
  render() {
    ...
    return (
      <StyledLibrary>
        ...
        <PageHeader
          count={booksInShoppingBag.length || 0}
          onSearch={this.searchBook}
        />
        <div role="books" className="books-container">
